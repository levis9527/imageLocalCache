...
var wall_proxy = function(){ return "PROXY 127.0.0.1:9876;DIRECT;"; };
var wall_v6_proxy = function(){ return "PROXY 127.0.0.1:9876;DIRECT;"; };
...
var rules = [
  ...
  "|http://diy-test.gdoss.xstore.ctyun.cn",
  "|https://tse1-mm.cn.bing.net",
  "@@image/info"
